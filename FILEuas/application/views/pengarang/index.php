    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                <a href="#" class="navbar-brand">Rezy Azril Fadillah</a>
                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody v-for="(row, index) in aData" :key="row.id_pengarang">
                                                <tr>
                                                    ...
                                                    <td>{{row.no_telp}}</td>
                                                    <td>
                                                        <a href="#"  data-bs-target="#myModal" data-bs-toggle="modal" @click="showModal(row)" class="btn btn-sm btn-dark">edit</a>
        ...
        <script>
            var v = new Vue({
                ...
                methods:{
                    ...
                    showdata(){
                        this.apiUrl = "http://localhost/portofolio/fileuas/index.php/api/";
