...
class Barang extends REST_Controller {
    ...
    function index_post(){
        $data = array(
            ...
            "barang_tgl_last_update"  => $this->post("barang_tgl_last_update")
        );

       
        $where = array("barang_id" => $this->post("barang_id"));
        $cek = $this->Mquery->ambildata($this->tabel, $where);
        if($cek->num_rows() == 0){
    ...
    function index_put(){
        $data = array(
            ...
            "barang_tgl_last_update"  => $this->put("barang_tgl_last_update")
        );

        $where = array('barang_id' => $this->put('barang_id'));
