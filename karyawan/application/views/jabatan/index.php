                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <a href="<?php echo site_url();?>/jabatan" class="text-white op-5 mb-2">| Jabatan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button data-bs-target="myModal" data-bs-toggle="modal"
                                            ...
                                            class="btn btn-outline-primary">Tambah Data Jabatan</button>
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody v-for="(row, index) in aData" :key="row.kd_jabatan">
                                                    <tr>
                                                        <td>{{index + 1}}</td>
                                                ...
                                                @click="showModal(row)" class="btn btn-sm btn-success">edit</a>
                                                            <a href="#" @click="hapusdata(row.kd_jabatan)" class="btn btn-sm btn-danger">delete</a>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="text" id="kd_jabatan" v-model="oData.kd_jabatan" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="text" id="nama_jabatan" v-model="oData.nama_jabatan" class="form-control" required>
                                </div>
                ...
                methods:{
                    showModal(oRow){
                        if(oRow == null) {
                            ...
                            this.oData.kd_jabatan = '';
                            this.oData.nama_jabatan = '';
                        }else{
                            this.oData.method = 'put';
                            this.oData.kd_jabatan = oRow.kd_jabatan;
                            this.oData.nama_jabatan = oRow.nama_jabatan;
                        }
                        $('#myModal').modal('show');
                    },
                    ...
                    hapusdata(id){
                        ...
                        if(konfirmasi)
                            axios.delete(this.apiUrl+'jabatan/'+id)
                                .then(response => {
                    ...
                    simpandata(){
                        ...
                        if(this.oData.method == 'post')
                            axios.post(this.apiUrl+'jabatan', dt)
                                .then(response => {
                                    this.showdata();
                                    $('#myModal').modal('hide');
                                    console.log(response.data);
                            ...
                            axios.put(this.apiUrl+'jabatan', dt, {
