						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?php echo base_url();?>assets/img/me1.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Rezy AF</h4>
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							<img src="<?php echo base_url();?>assets/img/profile.webp" alt="..." class="avatar-img rounded-circle">
						</div>
						<div class="info">
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <a href="<?php echo site_url();?>/karyawan" class="text-white op-5 mb-2">| Karyawan</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button data-bs-target="myModal" data-bs-toggle="modal"
                                            ...
                                            class="btn btn-outline-primary">Tambah Data Karyawan</button>
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                @click="showModal(row)" class="btn btn-sm btn-success">edit</a>
                                                            <a href="#" @click="hapusdata(row.kode_karyawan)" class="btn btn-sm btn-danger">delete</a>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class=col-md-6>
                                    ...
                                    <input type="text" id="kode_karyawan" v-model="oData.kode_karyawan" class="form-control" required>
                                </div>
                                <div class=col-md-6>
                            ...
                            <div class="row">
                                ...
                                <div class=col-md-6>
                                    <label>Email</label>
                                    <input type="text" id="email" v-model="oData.email" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-6 >
                                    <label>Jabatan</label>
                                    <select v-model="oData.jabatan" class="form-select form-select-sm mb-2" aria-label=".form-select-lg example" required>
                                        <option v-for="row in zData" :key="row.kd_jabatan" :value="row.nama_jabatan">{{row.nama_jabatan}}</option>
                                    </select>
                                </div>
                                <div class=col-md-6 >
                                    <label>Divisi</label>
                                    <select v-model="oData.divisi" class="form-select form-select-sm mb-2" aria-label=".form-select-lg example" required>
                                        <option v-for="row in dData" :key="row.kd_divisi" :value="row.nama_divisi">{{row.nama_divisi}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                ...
                methods:{
                    showModal(oRow){
                        if(oRow == null) {
                            ...
                            this.oData.kode_karyawan = oRow.kode_karyawan;
                        }
                        $('#myModal').modal('show');
                    },
                    ...
                    showdata(){
                        ...
                        axios.get(this.apiUrl+'karyawan')
                            .then(response => {
                    ...
                    hapusdata(idx){
                        ...
                        if(konfirmasi)
                            axios.delete(this.apiUrl+'karyawan/'+idx)
                                .then(response => {
                    ...
                    simpandata(){
                        ...
                        if(this.oData.method == 'post')
                            axios.post(this.apiUrl+'karyawan', dt)
                                .then(response => {
                                    this.showdata();
                                    $('#myModal').modal('hide');
                                    console.log(response.data);
                            ...
                            axios.put(this.apiUrl+'karyawan', dt, {
