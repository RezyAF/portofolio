						...
						<li class="nav-item dropdown hidden-caret">
							...
							<ul class="dropdown-menu dropdown-user animated fadeIn">
								<div class="dropdown-user-scroll scrollbar-outer">
									<li>
										<div class="user-box">
											<div class="avatar-lg"><img src="<?php echo base_url();?>assets/img/rezy.jpg" alt="image profile" class="avatar-img rounded"></div>
											<div class="u-text">
												<h4>Rezy Azril Fadillah</h4>
				...
				<div class="sidebar-content">
					<div class="user">
						<div class="avatar-sm float-left mr-2">
							<img src="<?php echo base_url();?>assets/img/cool.jpg" alt="..." class="avatar-img rounded-circle">
						</div>
						<div class="info">
                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <a href="<?php echo site_url();?>/absensi" class="text-white op-5 mb-2">| Absensi</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <form class="need-validation">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    <label>Lokasi</label>
                                    <input type="text" id="lokasi_absen" v-model="oData.lokasi_absen" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="time" id="jam_masuk" v-model="oData.jam_masuk" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="time" id="jam_keluar" v-model="oData.jam_keluar" class="form-control" required>
                                </div>
                ...
                methods:{
                    showModal(oRow){
                        if(oRow == null) {
                            ...
                            this.oData.tanggal = '';
                            this.oData.lokasi_absen = '';
                            this.oData.jam_masuk = '';
                            this.oData.jam_keluar = '';
                        }else{
                            this.oData.method = 'put';
                            this.oData.id = oRow.id;
                            this.oData.nama_karyawan = oRow.nama_karyawan;
                            this.oData.tanggal = oRow.tanggal;
                            this.oData.lokasi_absen = oRow.lokasi_absen;
                            this.oData.jam_masuk = oRow.jam_masuk;
                            this.oData.jam_keluar = oRow.jam_keluar;
                        }
                        $('#myModal').modal('show');
                    },
                    ...
                    hapusdata(id){
                        ...
                        if(konfirmasi)
                            axios.delete(this.apiUrl+'absensi/'+id)
                                .then(response => {
                    ...
                    simpandata(){
                        ...
                        if(this.oData.method == 'post')
                            axios.post(this.apiUrl+'absensi', dt)
                                .then(response => {
                                    this.showdata();
                                    $('#myModal').modal('hide');
                                    console.log(response.data);
                            ...
                            axios.put(this.apiUrl+'absensi', dt, {
