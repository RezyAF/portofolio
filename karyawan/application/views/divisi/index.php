                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <a href="<?php echo site_url();?>/divisi" class="text-white op-5 mb-2">| divisi</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button data-bs-target="myModal" data-bs-toggle="modal"
                                            ...
                                            class="btn btn-outline-primary">Tambah Data Divisi</button>
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody v-for="(row, index) in aData" :key="row.kd_divisi">
                                                    <tr>
                                                        <td>{{index + 1}}</td>
                                                        <td>{{row.kd_divisi}}</td>
                                                ...
                                                @click="showModal(row)" class="btn btn-sm btn-success">edit</a>
                                                            <a href="#" @click="hapusdata(row.kd_divisi)" class="btn btn-sm btn-danger">delete</a>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="text" id="kd_divisi" v-model="oData.kd_divisi" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="text" id="nama_divisi" v-model="oData.nama_divisi" class="form-control" required>
                                </div>
                ...
                methods:{
                    showModal(oRow){
                        if(oRow == null) {
                            ...
                            this.oData.kd_divisi = '';
                            this.oData.nama_divisi = '';
                        }else{
                            this.oData.method = 'put';
                            this.oData.kd_divisi = oRow.kd_divisi;
                            this.oData.nama_divisi = oRow.nama_divisi;
                        }
                        $('#myModal').modal('show');
                    },
                    ...
                    hapusdata(kd_divisi){
                        ...
                        if(konfirmasi)
                            axios.delete(this.apiUrl+'divisi/'+kd_divisi)
                                .then(response => {
                    ...
                    simpandata(){
                        ...
                        if(this.oData.method == 'post')
                            axios.post(this.apiUrl+'divisi', dt)
                                .then(response => {
                                    this.showdata();
                                    $('#myModal').modal('hide');
                                    console.log(response.data);
                            ...
                            axios.put(this.apiUrl+'divisi', dt, {
