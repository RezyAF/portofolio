                        ...
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    ...
                                    <a href="<?php echo site_url();?>/lembur" class="text-white op-5 mb-2">| Lembur</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button data-bs-target="myModal" data-bs-toggle="modal"
                                            ...
                                            class="btn btn-outline-primary">Tambah Data Lembur</button>
                                        <div class="table-responsive">
                                            <table class="table text-center">
                                                ...
                                                <tbody v-for="(row, index) in aData" :key="row.id_lembur">
                                                    <tr>
                                                        <td>{{index + 1}}</td>
                                                        <td>{{row.nama_karyawan}}</td>
                                                        <td>{{row.tanggal}}</td>
                                                        <td>{{row.jam_masuk_lembur}} | {{row.jam_keluar_lembur}}</td>
                                                        <td>{{row.keperluan}}</td>
                                                        <td>{{row.status}}</td>
                                                ...
                                                @click="showModal(row)" class="btn btn-sm btn-success">Show</a>
                                                            <a href="#" @click="hapusdata(row.id_lembur)" class="btn btn-sm btn-danger">delete</a>
                                                        </td>
                                                    </tr>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="time" id="jam_masuk_lembur" v-model="oData.jam_masuk_lembur" class="form-control" required>
                                </div>
                                <div class=col-md-12>
                                    <label>Jam Keluar Lembur</label>
                                    <input type="time" id="jam_keluar_lembur" v-model="oData.jam_keluar_lembur" class="form-control" required>
                                </div>
                            ...
                            <div class="row">
                                <div class=col-md-12>
                                    ...
                                    <input type="text" id="keperluan" v-model="oData.keperluan" class="form-control" required>
                                </div>
                ...
                methods:{
                    showModal(oRow){
                        if(oRow == null) {
                            ...
                            this.oData.tanggal = '';
                            this.oData.jam_masuk_lembur = '';
                            this.oData.jam_keluar_lembur = '';
                            this.oData.keperluan = '';
                            this.oData.status = '';
                        }else{
                            this.oData.method = 'put';
                            this.oData.id_lembur = oRow.id_lembur;
                            this.oData.nama_karyawan = oRow.nama_karyawan;
                            this.oData.tanggal = oRow.tanggal;
                            this.oData.jam_masuk_lembur = oRow.jam_masuk_lembur;
                            this.oData.jam_keluar_lembur = oRow.jam_keluar_lembur;
                            this.oData.keperluan = oRow.keperluan;
                    ...
                    hapusdata(id){
                        ...
                        if(konfirmasi)
                            axios.delete(this.apiUrl+'lembur/'+id)
                                .then(response => {
                    ...
                    simpandata(){
                        ...
                        if(this.oData.method == 'post')
                            axios.post(this.apiUrl+'lembur', dt)
                                .then(response => {
                                    this.showdata();
                                    $('#myModal').modal('hide');
                                    console.log(response.data);
                            ...
                            axios.put(this.apiUrl+'lembur', dt, {
